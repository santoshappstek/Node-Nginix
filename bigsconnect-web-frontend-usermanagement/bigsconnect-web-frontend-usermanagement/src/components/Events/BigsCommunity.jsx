...
import { getBigsEvents ,getRangeEventList} from '../../Store/events/eventsListAction';
...
export default connect(mapStateToProps, { getBigsEvents,getRangeEventList })(BigsCommunity)
